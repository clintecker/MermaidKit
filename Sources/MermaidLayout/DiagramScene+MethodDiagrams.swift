...
extension DiagramScene {
    ...
    static func from(_ layout: IshikawaLayout) -> DiagramScene {
        ...
        for rib in layout.ribs {
            ...
            let w = DiagramScene.estimatedLabelSize(rib.label).width
            labels.append(Label(
                text: rib.label,
            ...
            for twig in rib.twigs {
                ...
                let tw = DiagramScene.estimatedLabelSize(twig.label).width
                labels.append(Label(
                    text: twig.label,
    ...
    static func from(_ layout: EventModelingLayout) -> DiagramScene {
    ...
    static func from(_ layout: SwimlaneLayout) -> DiagramScene {
        var nodes: [Node] = layout.lanes.map {
        ...
        for lane in layout.lanes {
            let w = DiagramScene.estimatedLabelSize(lane.label).width
            labels.append(Label(
                text: lane.label,
